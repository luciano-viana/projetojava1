...
public class ExecutarTeste {
	...
	public static void main(String[] args) {
		...
		/*Para acessar os atributos da lista precisa ter um get da Lista na Classe "Venda"*/
		/*Adicionando objetivo produto na lista*/
		venda.getListaProdutos().add(produto1);
		venda.getListaProdutos().add(produto2);/*Não é possível fazer validações porque está pegando a lista e adicionando dentro dela*/
		...
		+ venda.getDescricaoVenda() + " e o total: " + venda.totalVenda());*/
