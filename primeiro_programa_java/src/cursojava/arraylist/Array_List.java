...
public class Array_List {
	...
	public static void main(String[] args) {
		...
		/*
		 * Método para cortar posições que não estão sendo utilizadas no ArrayList para
		 * não ocupar espaço na memória
		 */
		carros.trimToSize();// irá deixar o ArrayList somente com o tamanho de número dos elementos que
							// estão utilizando cada posição
